...
public class frm_add_edit_warehouse extends JDialog{
	JButton JBUpdate = new JButton(new ImageIcon("build/classes/images/save.png"));
	JButton JBReset = new JButton("Reset",new ImageIcon("build/classes/images/reset.png"));
	JButton JBCancel = new JButton("Cancel",new ImageIcon("build/classes/images/cancel.png"));
	...
	public frm_add_edit_warehouse(boolean ADD_STATE,JFrame OwnerForm,Connection srcCN,String srcSQL){
		...
		if(ADD_STATE==true){
			JLPic1.setIcon(new ImageIcon("build/classes/images/bNew.png"));
			setTitle("Add New Warehouse");
			JBUpdate.setText("Update");
		}else{
			JLPic1.setIcon(new ImageIcon("build/classes/images/bModify.png"));
