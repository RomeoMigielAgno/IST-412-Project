...
public class MainForm extends JFrame implements WindowListener{
	...
	String DBSource = "jdbc:ucanaccess://build/classes/database/MasterFile.mdb";
        //String DBSource = "jdbc:ucanaccess:///database/MasterFile.mdb";
	...
	public MainForm(){
		...
		setIconImage(new ImageIcon("build/classes/images/appicon.png").getImage());
		setLocation(0,0);
		setSize(screen);
		setResizable(true);
	...
	protected JMenuBar CreateJMenuBar(){
		...
		//End setup file menu
			...
			ItmLockApp.setIcon(new ImageIcon("build/classes/images/lockapplication.png"));
			...
			JMenuItem ItmLoggOff = new JMenuItem("Log Off");
			ItmLoggOff.setFont(new Font("Dialog", Font.PLAIN, 12));
			ItmLoggOff.setMnemonic('O');
			ItmLoggOff.setIcon(new ImageIcon("build/classes/images/loggoff.png"));
			...
			ItmExit.setIcon(new ImageIcon("build/classes/images/exit.png"));
		...
		//End records menu
			...
			ItmCustomer.setIcon(new ImageIcon("build/classes/images/customer.png"));
			...
			ItmSupplier.setIcon(new ImageIcon("build/classes/images/supplier.png"));
			...
			ItmSalesRep.setIcon(new ImageIcon("build/classes/images/SalesRep.png"));
			...
			ItmWarehouse.setIcon(new ImageIcon("build/classes/images/warehouse.png"));
			...
			ItmProduct.setIcon(new ImageIcon("build/classes/images/product.png"));
			...
			ItmCategory.setIcon(new ImageIcon("build/classes/images/categories.png"));
			...
			ItmStockAdj.setIcon(new ImageIcon("build/classes/images/adjustment.png"));
			...
			ItmInv.setIcon(new ImageIcon("build/classes/images/invoice.png"));
			...
			ItmPO.setMnemonic('O');
			ItmPO.setIcon(new ImageIcon("build/classes/images/purchaseorder.png"));
			...
			ItmRecieve.setIcon(new ImageIcon("build/classes/images/recieve.png"));
			...
			ItmExpense.setIcon(new ImageIcon("build/classes/images/expense.png"));
		...
		//End records menu
			...
			ItmNewInv.setIcon(new ImageIcon("build/classes/images/newinvoice.png"));
			...
			ItmNewPO.setIcon(new ImageIcon("build/classes/images/newpurchaseorder.png"));
			...
			ItmNewRecieve.setIcon(new ImageIcon("build/classes/images/newrecieve.png"));
			...
			ItmNewExpense.setIcon(new ImageIcon("build/classes/images/newexpense.png"));
	...
	protected JToolBar CreateJToolBar (){
		...
		NewJToolBar.add(CreateJToolbarButton("Customers Record","build/classes/images/customer.png","toolCus"));
		NewJToolBar.add(CreateJToolbarButton("Suppliers Record","build/classes/images/supplier.png","toolSup"));
		NewJToolBar.add(CreateJToolbarButton("SalesRep Record","build/classes/images/SalesRep.png","toolSalesrep"));
		NewJToolBar.add(CreateJToolbarButton("Warehouse Record","build/classes/images/Warehouse.png","toolWareh"));
		NewJToolBar.addSeparator();
		NewJToolBar.add(CreateJToolbarButton("Products Record","build/classes/images/product.png","toolProd"));
		NewJToolBar.add(CreateJToolbarButton("Categories Record","build/classes/images/categories.png","toolCat"));
		NewJToolBar.add(CreateJToolbarButton("Stock Adjustment Record","build/classes/images/adjustment.png","toolStockAdj"));
		NewJToolBar.addSeparator();
		NewJToolBar.add(CreateJToolbarButton("Invoices Record","build/classes/images/invoice.png","toolInv"));
		NewJToolBar.add(CreateJToolbarButton("Purchase Orders Record","build/classes/images/purchaseorder.png","toolPur"));
		NewJToolBar.add(CreateJToolbarButton("Purchase Receipt Record","build/classes/images/recieve.png","toolRecieve"));
		NewJToolBar.add(CreateJToolbarButton("Expenses Record","build/classes/images/expense.png","toolExpense"));
		NewJToolBar.addSeparator();
		NewJToolBar.add(CreateJToolbarButton("New Invoice","build/classes/images/newinvoice.png","toolNewInv"));
		NewJToolBar.add(CreateJToolbarButton("New Purchase Order","build/classes/images/newpurchaseorder.png","toolNewPur"));
		NewJToolBar.add(CreateJToolbarButton("New Purchase Receipt","build/classes/images/newrecieve.png","toolNewRecieveStock"));
		NewJToolBar.add(CreateJToolbarButton("New Expense","build/classes/images/newexpense.png","toolNewExpense"));
		NewJToolBar.addSeparator();
		NewJToolBar.add(CreateJToolbarButton("Business Setup","build/classes/images/businesssetup.png","toolBussSet"));
		NewJToolBar.add(CreateJToolbarButton("Security Option","build/classes/images/security.png","toolSecOpt"));
		NewJToolBar.add(CreateJToolbarButton("Lock Application","build/classes/images/lockapplication.png","toolLockApp"));
		NewJToolBar.addSeparator();
