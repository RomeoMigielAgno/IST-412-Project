...
public class FrmWarehouse extends JInternalFrame{
	...
	JLabel JLPicture1 = new JLabel(new ImageIcon("build/classes/images/helper.png"));
	...
	JButton JBAddNew = new JButton("Add New",new ImageIcon("build/classes/images/new.png"));
	JButton JBModify = new JButton("Modify",new ImageIcon("build/classes/images/modify.png"));
	JButton JBSearch = new JButton("Search",new ImageIcon("build/classes/images/search.png"));
	JButton JBPrint = new JButton("Print",new ImageIcon("build/classes/images/print.png"));
	JButton JBDelete = new JButton("Delete",new ImageIcon("build/classes/images/delete.png"));
	JButton JBReload = new JButton("Reload",new ImageIcon("build/classes/images/reload.png"));
	...
	public FrmWarehouse(Connection srcCN,JFrame getParentFrame) throws SQLException{
		...
		setFrameIcon(new ImageIcon("build/classes/images/Warehouse.png"));
